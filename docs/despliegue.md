...
- **frontend:** build estático de Angular servido por Nginx. Publica `4200:80`. El navegador llama a la API en `http://localhost:3000`.
...
3. Ejecuta el seed idempotente (supervisor demo + envíos demo).
...
- Seed: `pnpm db:seed` (supervisor demo + envíos demo)
